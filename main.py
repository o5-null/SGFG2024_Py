...
def naive_proxy(listen_port, proxy, type ='https'):
    ...
    if proxy == '龟苓膏':
        cmd = 'naive --listen=socks://0.0.0.0:'+listen_port+' --proxy='+type+'://sgfg:t2GhiyJOJlzk9fKm26O5eg==@worst-proxy.digital:443 --log='+log_path+' --log-net-log='+log_net_path
    elif proxy == '烧仙草':
        cmd = 'naive --listen=socks://0.0.0.0:'+listen_port+' --proxy='+type+'://sgfg:Q52uG0m0BeibMT49IzMc0g==@ni.su.dwg.us.in:443 --log='+log_path+' --log-net-log='+log_net_path
    elif proxy == '黑凉粉':
        cmd = 'naive --listen=socks://0.0.0.0:'+listen_port+' --proxy='+type+'://sgfg:toi7eOpDfgdqrIdIuHgs7w==@ns.iu.dwg.us.in:443 --log='+log_path+' --log-net-log='+log_net_path
